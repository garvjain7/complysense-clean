...
This document contains the official text of the Digital Personal Data Protection Act, 2023, including the operative provisions for consent, notice, lawful processing, and data principal rights.
...
<!-- meta: section_id=PREAMBLE, is_definitions=false, keep_whole=true, cross_refs=[], keywords=["preamble","consent","lawful processing","data principal rights"] -->
...
<!-- meta: section_id=SECTION_1, is_definitions=false, keep_whole=true, cross_refs=[], keywords=["short title","commencement"] -->
